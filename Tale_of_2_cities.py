...
print("-----------------------------------------------------")
file_path = "./datasets/A_tale_of_2_cities.txt"
...
def sequnce_dataset(data_as_int,seq_length = 100):
    ...
    print("Batched characters ")

    counter = 1 # for de_bugging
...
for input_example_batch, target_example_batch in dataset.take(1):
    ...
    print("Output_Prediction shape:",example_batch_predictions.shape, "# (batch_size, sequence_length(time_steps), vocab_size)")



"# (batch_size, sequence_length, vocab_size) --> for 1 batch consider 64 sequnces"
"and for each sequnce consider 100 charcters and each character is represented by an int(total 87 unique chars)"
...
checkpoint_dir = './checkpoints_tale'
